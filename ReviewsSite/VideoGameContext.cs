    ...
    public class VideoGameContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Review>().HasData(
                ...
                new Review() { Id = 6, Username = "Bort", Usercomment = "I would die for Kim Kitsuragi", VideoGameId = 1},
                new Review() { Id = 7, Username = "anarky", Usercomment = "I don't think there are many,if any, other games where you can play as a communist, schizophrenic, disco, cop.", VideoGameId = 1 },
                new Review() { Id = 8, Username = "Denky", Usercomment = "Disco Elysium is genius, one of the best games ever. Must play this if you like good writing and tabletop RPGs", VideoGameId = 1 },
                ...
                new Review() { Id = 9, Username = "MammadYmir", Usercomment = "A MUST-PLAY to fans of pretty much any genre of games. Anything more I'd wouldnt even begin to describe the magnificence of the gameplay, the environment, and all of the other elements", VideoGameId = 2},
                new Review() { Id = 10, Username = "Vox", Usercomment = "A mix between Skyrim & the newer Hitman games. Underrated masterpiece", VideoGameId = 2},
                new Review() { Id = 11, Username = "Wracky <3 Y", Usercomment = "If this game was a guy, I'll marry him.", VideoGameId = 2 },
                new Review() { Id = 3, Rating = 3.8, Username = "Barack Obama", Usercomment = "there was no cake :((((((((((((((((((((((((((((((((((((", VideoGameId = 3 },
                new Review() { Id = 12, Username = "VIC", Usercomment = "very neat! very cool! enjoyed every second despite the immense stress GLaDOS caused me in those last couple levels.", VideoGameId = 3 },
                new Review() { Id = 13, Username = "AshDragon", Usercomment = "The cake is a lieee!!!!!", VideoGameId = 3 },
                new Review() { Id = 14, Username = "Stellaris", Usercomment = "Great game good puzzle solving and challenging", VideoGameId = 3 },
                ...
                new Review() { Id = 15, Username = "YT_KameHameNah", Usercomment = "Fantastic puzzle game with a philosophy minigame hidden within", VideoGameId = 4 },
                new Review() { Id = 16, Username = "Sloppy Joe", Usercomment = "The Talos principle is a very good puzzle game. The gameplay is okay but the story is amazing. It's both challenging and engaging", VideoGameId = 4 },
                new Review() { Id = 17, Username = "Jacquee Mameet", Usercomment = "will make you think long and hard the next time you fail a captcha test", VideoGameId = 4 },
                new Review() { Id = 18, Username = "bug", Usercomment = "Good game to play when you're having an existential crisis", VideoGameId = 4 },
                ...
                new Review() { Id = 19, Username = "DrMiro", Usercomment = "side quests and the pretty environment keep me coming back. When you use mods the game can become a completely different game, so there's always something to check out.", VideoGameId = 5 },
                new Review() { Id = 20, Username = "Rob N", Usercomment = "Ruined my life. Five stars.", VideoGameId = 5 },
                new Review() { Id = 21, Username = "Pee Wee Herman", Usercomment = "All these DLC's make me feel alive", VideoGameId = 5 }
               );
            ...
            modelBuilder.Entity<VideoGamePlatform>().HasData(
               ...
               new VideoGamePlatform() { Id = 6, PlatformId = 1, VideoGameId = 1 },
